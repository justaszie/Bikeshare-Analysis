...
The project goal is to solve a business problem of a fictional company. But the dataset that was provided comes from a real-life business. It is the historical data of trips generated by a bikeshare service called [Divvy](https://divvybikes.com/), which is operated by Lyft in Chicago. It contains a large amount of data on rides from 2015 up to mid-2023. This data is [licensed out for public usage](https://divvybikes.com/data-license-agreement) by an agreement between Lyft and the city of Chicago. 

I had a free choice of scope in terms of timeframe for the analysis, so I chose to work with the data on rides from the full year of 2022.
...
See a few rows from the table below. You can also download a sample of the original dataset](Data_Samples/GDAC_sample_clean.csv).
